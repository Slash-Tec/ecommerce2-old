<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <aside>
            ...
            <ul class="divide-ydivide-gray-200">
                    ...
                    <li class="bg-white rounded-lg shadow">
                        <article>
                            ...
                            <div class="py-4 px-6">
                                ...
                                <p class="font-bold text-trueGray-700">{{ $product->prize }} &euro;</p>
                            </div>
                        </article>
                    </li>
                @endforeach
                            ...
                            <article class="flex">
                                ...
                                <div class="flex-1 py-4 px-6 flex flex-col">
                                    <div class="flex justify-between">
                                        <div>
                                            <h1 class="text-lg font-semibold text-gray-700">{{ $product->name }}</h1>h1>
